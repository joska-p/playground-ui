...
export const inputVariants = cva(
  "ui:border-input ui:ring-offset-background ui:file:text-foreground ui:focus-visible:ring-ring ui:rounded-md ui:border ui:px-3 ui:py-2 ui:text-base ui:file:border-0 ui:file:bg-transparent ui:file:text-sm ui:file:font-medium ui:focus-visible:ring-2 ui:focus-visible:ring-offset-2 ui:focus-visible:outline-hidden ui:disabled:cursor-not-allowed ui:disabled:opacity-50 ui:md:text-sm ui:h-10",
  {
    variants: {
      variant: {
        default:
